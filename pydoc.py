...
class HTMLDoc(Doc):
    ...
    def section(self, title, fgcol, bgcol, contents, width=6,
        ...
        result = '''<section><div class="section-header"><h2>%s</h2>''' % (title)
        if marginalia:
            result += '''<div class="marginalia">%s</div>''' % (marginalia)
        if prelude:
            result += '''<div class="prelude">%s</div>''' % (prelude)

        return result + '</div>\n<div class="section-body">%s</div></section>' % contents
    ...
    def multicolumn(self, list, format, cols=4):
        ...
        for col in range(cols):
            ...
            result = result + '</td>'
        return '<table class="list"><tr>%s</tr></table>' % result

    def grey(self, text): return '<span class="dim">%s</span>' % text
    ...
    def filelink(self, url, path):
        ...
        return '<a class="link-file" href="file:%s">%s</a>' % (url, path)
